...
@Component({
  selector: 'app-pps4-b-chat',
  templateUrl: './pps4-b-chat.page.html',
  styleUrls: ['./pps4-b-chat.page.scss'],
})
export class PPS4BChatPage implements OnInit {
  protected firebase = inject(FirebaseService);
  protected mensajes: Mensaje[] = [];
  subscribe: Subscription | null = null;
  protected msjNuevo = "";
  protected collection = "pps4b-chat"
